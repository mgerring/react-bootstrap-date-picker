...
CalendarHeader = /*#__PURE__*/function (_React$Component) {_inherits(CalendarHeader, _React$Component);function CalendarHeader() {var _getPrototypeOf2;var _this;_classCallCheck(this, CalendarHeader);for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}_this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(CalendarHeader)).call.apply(_getPrototypeOf2, [this].concat(args)));_defineProperty(_assertThisInitialized(_this), "displayingMinMonth",
    ...
    {
      return (
        _react.default.createElement("div", { className: "text-center" },
...
Calendar = /*#__PURE__*/function (_React$Component2) {_inherits(Calendar, _React$Component2);function Calendar() {var _getPrototypeOf3;var _this2;_classCallCheck(this, Calendar);for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {args[_key2] = arguments[_key2];}_this2 = _possibleConstructorReturn(this, (_getPrototypeOf3 = _getPrototypeOf(Calendar)).call.apply(_getPrototypeOf3, [this].concat(args)));_defineProperty(_assertThisInitialized(_this2), "handleClick",
    ...
    function (e) {
      ...
      var newSelectedDate = _this2.setTimeToNoon(
      new Date(_this2.props.displayDate));
    ...
    {var _this3 = this;
      ...
      for (var i = 0; i < 9; i++) {
        ...
        for (var j = 0; j <= 6; j++) {
          if (day <= monthLength && (i > 0 || j >= startingDay)) {
            ...
            week.push(_react.default.createElement("td", { key: j }));
          }
        }
        ...
        weeks.push(_react.default.createElement("tr", { key: i }, week));
        if (day > monthLength) {
          break;
        }
      }

      var weekColumn = showWeeks ?
      _react.default.createElement("td", {
      ...
      return (
        _react.default.createElement("table", { className: "text-center" },
        ...
        _react.default.createElement("tfoot", null,
        _react.default.createElement("tr", null,
        _react.default.createElement("td", {
...
DatePicker = /*#__PURE__*/function (_React$Component3) {_inherits(DatePicker, _React$Component3);
  ...
  function DatePicker(props) {var _this4;_classCallCheck(this, DatePicker);
    _this4 = _possibleConstructorReturn(this, _getPrototypeOf(DatePicker).call(this, props));_defineProperty(_assertThisInitialized(_this4), "makeDateValues",
    ...
    {var _this5 = this;
      ...
      return (
        ...
        _react.default.createElement(_reactBootstrap.InputGroup.Text, null,
        _react.default.createElement("div", {
          style: {
            opacity:
    ...
    } }]);return DatePicker;}(_react.default.Component);
...
/*
                                                                 <Overlay
                                                                   ...
                                                                   container={() =>
                                                                     this.props.calendarContainer || this.overlayContainer
                                                                   }
                                                                   target={this.input}
